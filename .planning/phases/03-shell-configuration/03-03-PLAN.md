...
must_haves:
  truths:
    - "308-line aliases file is split into 6 category files in dot_config/zsh/aliases/"
...
Run: `grep 'oh-my\|OMZ\|OMB\|Oh My' ~/.dotfiles/dot_config/zsh/aliases/*.zsh` should return nothing.
  ...
  <done>6 alias category files created with all aliases from existing 308-line file properly categorized. New useful aliases added per ALIAS-03. No hardcoded paths, no project-specific aliases, no Oh My Zsh/Bash references. All syntax is POSIX-compatible for bash sharing.</done>
</task>
