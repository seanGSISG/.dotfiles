...
```bash
/home/adminuser/.claude/bin/codeagent-wrapper --progress --backend antigravity - "$(pwd)" <<'FRONTEND_EOF'
ROLE_FILE: /home/adminuser/.claude/.ccg/prompts/antigravity/$ROLE.md
<TASK>
{任务描述 + 上下文}
</TASK>
OUTPUT: {期望输出格式}
FRONTEND_EOF
&
/home/adminuser/.claude/bin/codeagent-wrapper --progress --backend claude - "$(pwd)" <<'CLAUDE_EOF'
ROLE_FILE: /home/adminuser/.claude/.ccg/prompts/claude/$ROLE.md
<TASK>
{任务描述 + 上下文}
</TASK>
OUTPUT: {期望输出格式}
...
```bash
/home/adminuser/.claude/bin/codeagent-wrapper --progress --backend antigravity - "$(pwd)" <<'EOF'
ROLE_FILE: /home/adminuser/.claude/.ccg/prompts/antigravity/$ROLE.md
<TASK>
{任务描述 + 上下文}
</TASK>
...
#### Claude（架构/安全/复杂推理）
```bash
/home/adminuser/.claude/bin/codeagent-wrapper --progress --backend claude - "$(pwd)" <<'EOF'
ROLE_FILE: /home/adminuser/.claude/.ccg/prompts/claude/$ROLE.md
<TASK>
{任务描述 + 上下文}
</TASK>
...
/home/adminuser/.claude/bin/codeagent-wrapper --progress --backend antigravity - "$(pwd)" <<'EOF'
ROLE_FILE: /home/adminuser/.claude/.ccg/prompts/antigravity/reviewer.md
<TASK>审查以下代码变更：$(git diff)</TASK>
OUTPUT: Critical/Warning/Info 分级审查报告
EOF
&
/home/adminuser/.claude/bin/codeagent-wrapper --progress --backend claude - "$(pwd)" <<'EOF'
ROLE_FILE: /home/adminuser/.claude/.ccg/prompts/claude/reviewer.md
<TASK>审查以下代码变更：$(git diff)</TASK>
OUTPUT: Critical/Warning/Info 分级审查报告
EOF
&
