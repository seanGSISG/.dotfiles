...
INSIGHTS_DIR = Path.home() / ".claude" / "insights"
INSTINCTS_DIR = INSIGHTS_DIR / "instincts"
PERSONAL_DIR = INSTINCTS_DIR / "personal"
INHERITED_DIR = INSTINCTS_DIR / "inherited"
EVOLVED_DIR = INSIGHTS_DIR / "evolved"
OBSERVATIONS_FILE = INSIGHTS_DIR / "observations.jsonl"
