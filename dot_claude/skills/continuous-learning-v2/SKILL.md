...
```bash
mkdir -p ~/.claude/insights/{instincts/{personal,inherited},evolved/{agents,skills,commands}}
touch ~/.claude/insights/observations.jsonl
```
...
```json
{
  ...
  "observation": {
    "enabled": true,
    "store_path": "~/.claude/insights/observations.jsonl",
    "max_file_size_mb": 10,
    "archive_after_days": 7
  },
  "instincts": {
    "personal_path": "~/.claude/insights/instincts/personal/",
    "inherited_path": "~/.claude/insights/instincts/inherited/",
    "min_confidence": 0.3,
  ...
  "evolution": {
    "cluster_threshold": 3,
    "evolved_path": "~/.claude/insights/evolved/"
  }
}
```
